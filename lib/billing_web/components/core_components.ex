defmodule BillingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BillingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BillingWeb.Gettext, "errors", msg, opts)
    end
  end
